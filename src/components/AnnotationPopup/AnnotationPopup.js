    ...
    >
      {isStylePopupOpen ? (
        ...
        <CustomizablePopup dataElement="annotationPopup">
          {!isEditingWidgets && !isNotesPanelDisabled && !multipleAnnotationsSelected && firstAnnotation.ToolName !== 'CropPage' && (
            <ActionButton
          ...
          {!isEditingWidgets && redactionEnabled && !multipleAnnotationsSelected && (
            <ActionButton
          ...
          {!['CropPage', 'AnnotationCreateSignature', 'AnnotationCreateRedaction', 'AnnotationCreateSticky'].includes(
            firstAnnotation.ToolName,
          ) && !isEditingWidgets && (
            <ActionButton
              title="tool.Link"
